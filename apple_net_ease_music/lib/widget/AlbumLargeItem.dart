      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            ...
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, height: 1.5),
          ),
          Text(
            this.artist,
            textAlign: TextAlign.left,
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, height: 1.5, color: Colors.black54),
          ),
          Container(
